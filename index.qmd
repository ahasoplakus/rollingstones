...
df_albums <- rolling_stone |>
  ...
  select(
    ...
    "Position" = "peak_billboard_position",
    "Weeks" = "weeks_on_billboard",
...
df_albums |>
  ...
  tab_style(
    style = cell_fill(color = "#FFF2D7", alpha = 0.5),
    locations = cells_body(columns = c(8, 10))
  ) |>
  tab_style(
    style = cell_fill(color = "#000000"),
    locations = cells_body(columns = 11:12)
  ) |>
  tab_style(
